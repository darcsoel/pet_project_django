"""
Django settings for pet_project_django project.
...
DEBUG = bool(environ.get("DEBUG_MODE", True))  # set as true to simplify dev process
...
ROOT_URLCONF = "pet_project_django.urls"
...
WSGI_APPLICATION = "pet_project_django.wsgi.application"
